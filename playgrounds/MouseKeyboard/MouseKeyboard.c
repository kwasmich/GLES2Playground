...
static void mouseDidMove(const int8_t in_DX, const int8_t in_DY) {
    //printf("move: %d %d\n", in_DX, in_DY);
}



static void mouseDidScroll(const int8_t in_DX, const int8_t in_DY) {
    printf("scroll: %d %d\n", in_DX, in_DY);
}



static void mouseDown(const int8_t in_BUTTON) {
    printf("%d down\n", in_BUTTON);
}



static void mouseUp(const int8_t in_BUTTON) {
    printf("%d up\n", in_BUTTON);
}
...
static void update() {
    mouseGet(mouseDidMove, mouseDown, mouseUp, mouseDidScroll);
...
GLES2Playground_t e_playgroundMouseKeyboard = {
    .name = "Font",
    .init = init,
    .deinit = deinit,
    .update = update,
