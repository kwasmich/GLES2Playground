...
static void loadShaders() {
    GLuint vertShaderObject = createShaderObject("playgrounds/Arabesque/Assets/Shaders/Arabesque.vsh", GL_VERTEX_SHADER);
    error();
    GLuint fragShaderObject = createShaderObject("playgrounds/Arabesque/Assets/Shaders/Arabesque.fsh", GL_FRAGMENT_SHADER);
    error();
...
static void loadTextures() {
    s_texture = createTextureObject("playgrounds/Arabesque/Assets/Textures/CircleMip.etc1", GL_ETC1_RGB8_OES);
}
